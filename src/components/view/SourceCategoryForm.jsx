...
const allSourceCategories = [
    {id: 0, text: "Зачем люди смотрят телевизор"},
    {id: 1, text: "Зачем люди едят"},
    {id: 2, text: "Зачем люди лгут"},
    {id: 3, text: "Зачем люди пишут диссертации"},
    {id: 4, text: "Зачем люди играют в футбол"},
    {id: 5, text: "Зачем люди ходят на работу"},
    {id: 6, text: "Зачем люди пьют алгоколь"},
    {id: 7, text: "Зачем люди убивают"},
    {id: 8, text: "Зачем люди путешествуют"},
    {id: 9, text: "Зачем люди занимаются любовью"},
    {id: 10, text: "Зачем люди играют в компьютерные игры"},
];
